...
import hackyeah.service.MailService
import hackyeah.service.UserService
import hackyeah.service.dto.PasswordChangeDTO
import hackyeah.service.dto.UserDTO
import hackyeah.web.rest.errors.EmailAlreadyUsedException
import hackyeah.web.rest.errors.EmailNotFoundException
import hackyeah.web.rest.errors.InternalServerErrorException
import hackyeah.web.rest.errors.InvalidPasswordException
import hackyeah.web.rest.errors.LoginAlreadyUsedException
import hackyeah.web.rest.vm.KeyAndPasswordVM
import hackyeah.web.rest.vm.ManagedUserVM
...
@RestController
@RequestMapping("/api")
class AccountResource(private val userRepository: UserRepository, private val userService: UserService, private val mailService: MailService, private val persistentTokenRepository: PersistentTokenRepository) {
    ...
    val account: UserDTO
        ...
        get() = userService.userWithAuthorities
                .map<UserDTO>(Function<User, UserDTO> { UserDTO(it) })
    ...
    fun requestPasswordReset(@RequestBody mail: String) {
        mailService.sendPasswordResetMail(
                userService.requestPasswordReset(mail)
                        .orElseThrow<EmailNotFoundException>(Supplier<EmailNotFoundException> { EmailNotFoundException() })
        )
    }
