package pl.epoint.hackyeah.aop.logging
...
class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut("within(pl.epoint.hackyeah.repository..*)" +
            " || within(pl.epoint.hackyeah.service..*)" +
            " || within(pl.epoint.hackyeah.web.rest..*)")
